module.exports = class FPW_Widgets_Small {
    ...
    async simpleWidget(vData) {
        ...
        try {
            ...
            await this.FPW.WidgetHelpers.createTimeStampElement(timestampRow, vehicleData, wSize);
        } catch (e) {
            console.error(`simpleWidget(small) Error ${e}`);
            this.FPW.Files.appendToLogFile(`simpleWidget(small) Error: ${e}`);
        }
        return widget;
    }
    ...
    async detailedWidget(vData) {
        ...
        try {
            ...
            console.error(`detailedWidget(small) Error ${e}`);
            this.FPW.Files.appendToLogFile(`detailedWidget(small) Error: ${e}`);
        }
        return widget;
    }
