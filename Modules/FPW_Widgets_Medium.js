module.exports = class FPW_Widgets_Medium {
    ...
    async simpleWidget(vData) {
        ...
        try {
            ...
            //* Column 1
            //*****************
            let mainCol1 = await this.FPW.WidgetHelpers.createColumn(contentStack, { '*setPadding': [0, 0, 0, 0], '*centerAlignContent': null });

            let col1Row = await this.FPW.WidgetHelpers.createRow(mainCol1, { '*setPadding': [0, 0, 0, 0], '*centerAlignContent': null });

            // Vehicle Logo
            await this.FPW.WidgetHelpers.createVehicleImageElement(col1Row, vehicleData, 145, 105);
            ...
            await this.createFuelRangeElements(mainCol2, vehicleData, wSize);
            ...
            await this.createLockStatusElement(mainCol3, vehicleData, wSize);
            ...
            console.error(`simpleWidget(medium) Error: ${e}`);
            this.FPW.Files.appendToLogFile(`simpleWidget(medium) Error: ${e}`);
        }
        return widget;
    }
    ...
    async detailedWidget(vData) {
        ...
        try {
            ...
            console.error(`detailedWidget(medium) Error: ${e}`);
            this.FPW.Files.appendToLogFile(`detailedWidget(medium) Error: ${e}`);
        }
        return widget;
    }
